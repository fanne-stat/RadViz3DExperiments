...
save(overlap_mat_sim, sim_data, file = "sim_data__hs_5.rda")
```
...
overlap.map(overlap_map_sym*1000, lab.col = oil.palette[1:K], 
            scale = expression(""%*%10^-3~""), map.cex = 2.75, lab.cex = 4, 
            font = 2, legend.cex = 1.5, scale.pos = 1.5, legend.width = 2)
```
<br />
Overlap Map
</td>
...
<td align="center" valign="center">
```{r}
radialvis3d(data = df[,-1], cl = factor(df$class), domrp = F, doGtrans = F, lwd = 2, alpha = 0.325, pradius = 0.02, color = oil.palette, coord.cex = 1.5,
            class.labels = NULL)
# rgl::par3d(windowRect = c(0, 0, 1200, 1200))
# rgl::par3d(viewport = c(0,0,1200, 1200))
rgl::rgl.viewpoint(zoom = 0.6)
